...
8.24 Nel caso di farmaci per sperimentazioni cliniche, devono essere indicati e identificati tutti i siti dove vengono eseguiti i trial clinici e i paesi di destinazione. Nel caso di un medicinale sperimentale per il quale è stata rilasciata un'autorizzazione all'immissione in commercio, il produttore deve, in collaborazione con lo sponsor, informare il titolare dell'autorizzazione all'immissione in commercio di qualsiasi difetto di qualità che potrebbe essere correlato al medicinale autorizzato. Lo sponsor deve attuare una procedura per il rapido sblocco dei prodotti in cieco, laddove ciò sia necessario per un rapido richiamo. Lo sponsor deve garantire che la procedura renda noto l'identità del prodotto in cieco solo nella misura necessaria.
